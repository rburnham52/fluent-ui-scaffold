...
|--------|-------------|------------|
| `CreateAspNetCore` | Creates ASP.NET Core server configuration | `Uri baseUrl, string projectPath` |
| `CreateAspire` | Creates Aspire App Host configuration | `Uri baseUrl, string projectPath` |
| `CreateNodeJs` | Creates Node.js server configuration | `Uri baseUrl, string projectPath` |
