...
namespace SampleApp.Tests.Examples
{
    ...
    public class FrameworkTests
    {
        ...
        public async Task DebugModeConfiguration_WhenDebugModeEnabled_SetsCorrectOptions()
        {
            ...
            Assert.AreEqual(new Uri("http://localhost:5000"), options.BaseUrl, "Base URL should be set correctly");
        ...
        public async Task PageObjectCreation_WhenServiceProviderAvailable_CreatesPageObjects()
        {
            ...
            var loginPage = new Pages.LoginPage(app.ServiceProvider, new Uri("http://localhost:5000"));
