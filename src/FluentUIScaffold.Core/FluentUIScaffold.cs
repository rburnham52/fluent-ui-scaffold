...
namespace FluentUIScaffold.Core {
    ...
    public class FluentUIScaffoldApp<TApp> where TApp : class {
        ...
        /// <summary>
        /// Creates a new FluentUIScaffold instance for web applications.
        /// </summary>
        /// <param name="configureOptions">Optional configuration action</param>
        /// <returns>A configured FluentUIScaffold instance</returns>
        ...
        /// <summary>
        /// Creates a new FluentUIScaffold instance for mobile applications.
        /// </summary>
        /// <param name="configureOptions">Optional configuration action</param>
        /// <returns>A configured FluentUIScaffold instance</returns>
